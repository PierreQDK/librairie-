...
- L’élu le plus âgé est Simone Veil, âgée de 74 ans.
...
- Il contient 10 communes différentes.
- L’élu le plus âgé est Pasteur (78 ans).
- L’élu le plus jeune est Flaubert (23 ans).
...
Cette fonction génère un rapport Quarto au format HTML contenant :

- Une analyse des élus d’une commune et d’un département.
...
- commune : Code de la commune à analyser.

- departement : Code du département à analyser.

- output : Nom du fichier de sortie.

Exemple d’utilisation
```{r}
#generer_rapport(commune = "Nantes", departement = "Loire-Atlantique", output = "rapport_nantes.html")
```

Résultat :

Un fichier rapport_nantes.html est généré et contient toutes les analyses de la commune et du département sélectionnés.
