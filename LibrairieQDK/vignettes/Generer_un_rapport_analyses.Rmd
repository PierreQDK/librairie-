...
- La médiane d’âge des élus est 52 ans.
...
### Execution de generer_rapport
```{r}
# Générer un rapport pour la commune 44135 et le département 44
generer_rapport("44135", "44", "rapport_commune.html")
```
